...
#define DEFAULT_UART_BUF_SIZE      512//128
...
#define WRONG_INPUT_DATA        0x13    //checksum error
...
//extern char SmartServo_Version[7];
...
extern volatile uint32_t flush_uart1_forward_time;
extern volatile uint32_t flush_uart0_local_time;

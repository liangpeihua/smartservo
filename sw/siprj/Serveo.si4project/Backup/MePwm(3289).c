...
void pwm_init(int pin,int fq)
{
	...
	s_max_cnt = SystemCoreClock/2/fq;//prescaler 2
	...
	switch(pin)
	{
		case 0x20:
			...
			PWMA->CNR0 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x21:
			...
			PWMA->CNR1 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x22:
			...
			PWMA->CNR2 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x23:
			...
			PWMA->CNR3 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x24:
			...
			PWMB->CNR0 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x25:
			...
			PWMB->CNR1 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x26:
			...
			PWMB->CNR2 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		...
		case 0x27:
			...
			PWMB->CNR3 = s_max_cnt;															 //Set PWM Timer period
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			break;
		default:
			break;
...
void pwm_write(int pin, int value,int min,int max)
{
  int value_tmp;
	...
	value_tmp = (int)map(value_tmp, min, max, 0, s_max_cnt);//value_tmp: 	motor pwm duty

...
#define DATA_FLASH_ADDR_END         (FMC->DFBADR + 0x1000)	//4K Data Flash
...
#define USER_DATA_CMD_MODE_END_ADDR    USER_DATA_CMD_MODE + 4	//data flash的第一页开始存储命令模式
...
#define USER_DATA_ANGLE_OFFSET_END_ADDR    USER_DATA_ANGLE_OFFSET + 4	//存储命令模式的4个字节之后存储角度偏移量

...
//PWM fq = 50000000 / PRESCALER / DIVIDER/ CNR0 = 50000000 / 2 / 1 / CNR0 = 20000
//CNR0 = 1250
...
void pwm_init(int pin,int fq)
{
	...
	switch(pin)
	{
		case 0x20:
			...
			//PWM_EnableDeadZone(PWMA, PWM_CH0, 1);					//set dead zone 1			
			break;
		...
		case 0x21:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMA, PWM_CH1, 1);					//set dead zone 1	
			break;
		...
		case 0x22:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMA, PWM_CH2, 1);					//set dead zone 1	
			break;
		...
		case 0x23:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMA, PWM_CH3, 1);					//set dead zone 1	
			break;
		...
		case 0x24:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMB, PWM_CH0, 1);					//set dead zone 1	
			break;
		...
		case 0x25:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMB, PWM_CH1, 1);					//set dead zone 1	
			break;
		...
		case 0x26:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMB, PWM_CH2, 1);					//set dead zone 1	
			break;
		...
		case 0x27:
			...
			pwm_writeMicroseconds(pin, 0);//Set PWM Duty 0
			//PWM_EnableDeadZone(PWMB, PWM_CH3, 1);					//set dead zone 1	
			break;
		default:
			break;
	}
